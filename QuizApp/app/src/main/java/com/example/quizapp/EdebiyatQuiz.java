...
public class EdebiyatQuiz extends AppCompatActivity {
        ...
        aans.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (currentQuestions<questionsItems.size()-1){
                    ...
                    Intent intent= new Intent(EdebiyatQuiz.this,ResultActivity.class);
    ...
    private void loadAllQuestions(){
        ...
        String jsonquiz=loadJsonFromAsset("edebiyatquestions.json");
        try{
            JSONObject jsonObject=new JSONObject(jsonquiz);
            JSONArray questions= jsonObject.getJSONArray("edebiyatquestions");
    ...
    public void onBackPressed() {
        MaterialAlertDialogBuilder materialAlertDialogBuilder= new MaterialAlertDialogBuilder(EdebiyatQuiz.this);
        ...
        materialAlertDialogBuilder.setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialogInterface,int i) {
                startActivity(new Intent(EdebiyatQuiz.this,MainActivity.class));
                finish();
            }
        });
